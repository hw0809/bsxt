										...
										<div class="col-xs-12">
											<div class="form-group">
												<label class="col-sm-1 control-label no-padding-right"
													for="class">班级</label>
												<div class="col-sm-2">
													<input type="text" id="classes" name="classes" placeholder="班级" />
												</div>
	...
	<script type="text/javascript">
                ...
                $('#btn').click(function(){  
                    if(checkData()){  
                        $('#excelForm').ajaxSubmit({    
                            url:'${dormitory}/classes/uploadExcel',  
                            dataType: 'text',  
		...
		jQuery(function($) {
			...
			jQuery(grid_selector).jqGrid({
				url : "${dormitory}/classes/getPageList",
				height : 250,
				datatype : "json",
				colNames : [ 'id', '班级', '系别' ],
				colModel : [ {
		...
		var del = function() {
			...
			window.parent.myConfirm("您是否确定删除信息", buttonType,
					confirmFunction);
		};
		...
		var download = function() {
			window.location.href = "${dormitory}/down/classes.xlsx";
		};
