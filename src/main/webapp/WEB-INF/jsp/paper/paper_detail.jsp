...
<body>
							...
							<div class="widget-body">
								<div class="widget-main">
									<form class="form-horizontal" role="form" id="commitForm">
										...
										<!-- <div class="form-group">
											<label class="col-sm-3 control-label no-padding-right"
												for="account">评价</label>

											<div class="col-sm-4">
												<textarea class="form-control" placeholder="评价"
													id="apperise" name="apperise" rows="5" maxlength="50"></textarea>
											</div>
										</div> -->
									</form>
	...
	<script type="text/javascript">
		var submitForm = function(data) {
			$("#review").val(data);
			$.ajax({
				url : "${dormitory}/paper/reviewPaper",
				type : "post",
				...
				success : function(result) {
					if (result.flag) {
						...
						setTimeout("refreshTab('tab_submitPaperId')",2000);
						setTimeout("closeTab('tab_paperDetailId')",2000);
					}
				}
			});
		}
