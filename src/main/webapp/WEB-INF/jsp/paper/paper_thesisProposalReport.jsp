...
<body>
					...
					<div class="col-xs-12">
						<form id="submitForm" class="form-horizontal" role="form">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" placeholder="标题" name="title" id="title"
										readonly="" value="${student.thesisProposalTitle }"
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<textarea class="form-control" id="evaluate" name="evaluate" placeholder="评价"
										rows="5" maxlength="50">${student.thesisProposalEvaluate }</textarea>
								</div>
							</div>
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								&nbsp; &nbsp; &nbsp;
								<button class="btn btn-info" type="button"
									onclick="downThesisProposal()">下载开题报告</button>
							</div>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript">
		var downThesisProposal = function() {
			window.location.href = "${dormitory}/paper/downReport?account=${student.account}";
		};

		var submitForm = function() {
			$.ajax({
				url : "${dormitory}/paper/saveThesisProposalEvaluate",
				type : "post",
				dataType : "json",
