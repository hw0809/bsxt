...
<body>
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input type="text" id="account" name="account"
													value="${student.account}" placeholder="学号"
													class="form-control" />
											</div>
										</div>
	...
	<script type="text/javascript">
		...
		var code = "${student.department.departmentCode}";
		...
		var initClasses = function(code, classesId) {
			$.ajax({
		...
		var initDepartments = function(initDepartmentCode) {
			$.ajax({
						url : "${dormitory}/student/departmentsList",
						type : "post",
						dataType : "json",
						success : function(data) {
							$.each(data,function() {
							...
							$("#department").val(initDepartmentCode);
						}
					});
		};
