	...
	<script type="text/javascript">
			...
			$('#btn').click(function() {
				if (checkData()) {
					$('#excelForm').ajaxSubmit({
						url : '${dormitory}/teacher/uploadExcel',
						dataType : 'text',
		...
		jQuery(function($) {
			...
			jQuery(grid_selector).jqGrid({
				url : "${dormitory}/teacher/getPageList",
				height : 250,
				datatype : "json",
				colNames : [ 'id', '工号', '姓名', '系别' ],
				colModel : [ {
					name : 'id',
					index : 'id',
					editable : true,
		...
		var download = function() {
			window.location.href = "${dormitory}/down/teacher.xlsx";
		};
