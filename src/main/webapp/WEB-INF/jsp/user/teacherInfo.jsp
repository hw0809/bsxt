						...
						<form id="submitForm" class="form-horizontal" role="form">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" placeholder="系别" readonly=""
										value="${teacher.departmentName }" class="form-control" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" placeholder="手机" name="tel" id="tel"
										value="${teacher.tel }" class="form-control" />
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right"
									for="desc"> 简介</label>
								<div class="col-sm-4">
									<textarea class="form-control" name="desc" placeholder="简介">${teacher.desc }</textarea>
								</div>
							</div>
						</form>
